...
export class Photo extends plugin {
  ...
  async Searchoperas(e) {
    ...
    const url = `https://api.themoviedb.org/3/search/tv?query=${msg}&include_adult=${r_18}&language=zh-CN&page=1`;
  ...
  async Searchmovies(e) {
    ...
    const url = `https://api.themoviedb.org/3/search/movie?query=${msg}&include_adult=${r_18}&language=zh-CN&page=1`;
  ...
  async person(e) {
    ...
    const url = `https://api.themoviedb.org/3/search/person?query=${msg}&include_adult=${r_18}&language=zh-CN&page=1`;
